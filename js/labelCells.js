...
export function trainLabelCellsReference(testFeatures, loadedReference, referenceFeatures, { top = 20, numberOfThreads = null } = {}) {
    ...
    if (referenceFeatures.length != loaded.numberOfFeatures()) {
...
/**
 * Wrapper around the integrated cell labelling results on the Wasm heap, typically produced by {@linkcode integratedLabelCells}.
 * @hideconstructor
 */
class IntegratedLabelCellsResults {
    #id
    #results;
 ...
 */
export function integratedLabelCells(x, assigned, integrated, { numberOfFeatures = null, numberOfCells = null, quantile = 0.8, numberOfThreads = null } = {}) { 
