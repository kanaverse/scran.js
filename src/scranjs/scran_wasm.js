...
var wasmBinaryFile;
  wasmBinaryFile = 'scran_wasm.wasm';
...
var ASM_CONSTS = {
  54856: function($0, $1) {console.log("__scran_wasm__ " + "read_matrix_market" + " " + $0 + " " + $1 + " " + "Loading Matrix Market file");},  
 54974: function($0, $1) {console.log("__scran_wasm__ " + "read_matrix_market" + " " + $0 + " " + $1 + " " + "Done");},  
 55070: function($0, $1) {console.log("__scran_wasm__ " + "read_matrix_market" + " " + $0 + " " + $1 + " " + "Done");},  
 55166: function($0, $1) {console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Assigning lines to submatrices");},  
 55304: function($0, $1) {console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Building the submatrices");},  
 55436: function($0, $1) {console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Done");},  
 55548: function($0, $1) {console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Assigning lines to submatrices");},  
 55686: function($0, $1) {console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Building the submatrices");},  
 55818: function($0, $1) {console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Done");},  
 55930: function() {throw 'Canceled!'}
};
function initPthreadsJS(){ PThread.initRuntime(); }
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],initMainThreadBlock:function() {
        ...
        var pthreadMainJs = locateFile('scran_wasm.worker.js');
  ...
  function ___sys_ftruncate64(fd, zero, low, high) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(3, 1, fd, zero, low, high);
    try {
  ...
  function ___sys_mmap2(addr, len, prot, flags, fd, off) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(5, 1, addr, len, prot, flags, fd, off);
    try {
...
var proxiedFunctionTable = [null,_atexit,___sys_fcntl64,___sys_ftruncate64,___sys_ioctl,___sys_mmap2,___sys_munmap,___sys_open,___sys_unlink,_abort,_emscripten_set_canvas_element_size_main_thread,_fd_close,_fd_read,_fd_seek,_fd_write];
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 54544;
var __emscripten_main_thread_futex = Module['__emscripten_main_thread_futex'] = 60804;
