...
function allocate(slab, allocator) {
 ...
 if (slab.subarray || slab.slice) {
  ...
  GROWABLE_HEAP_U8().set(new Uint8Array(slab), ret >>> 0);
 }
 return ret;
}
...
function writeStackCookie() {
 ...
 assert((max & 3) == 0);
 GROWABLE_HEAP_U32()[(max >> 2) + 1 >>> 0] = 34821223;
 GROWABLE_HEAP_U32()[(max >> 2) + 2 >>> 0] = 2310721022;
...
function checkStackCookie() {
 if (ABORT) return;
 var max = _emscripten_stack_get_end();
 var cookie1 = GROWABLE_HEAP_U32()[(max >> 2) + 1 >>> 0];
 var cookie2 = GROWABLE_HEAP_U32()[(max >> 2) + 2 >>> 0];
...
var ASM_CONSTS = {
 54856: function($0, $1) {
  console.log("__scran_wasm__ " + "read_matrix_market" + " " + $0 + " " + $1 + " " + "Loading Matrix Market file");
 },
 54974: function($0, $1) {
  console.log("__scran_wasm__ " + "read_matrix_market" + " " + $0 + " " + $1 + " " + "Done");
 },
 55070: function($0, $1) {
  console.log("__scran_wasm__ " + "read_matrix_market" + " " + $0 + " " + $1 + " " + "Done");
 },
 55166: function($0, $1) {
  console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Assigning lines to submatrices");
 },
 55304: function($0, $1) {
  console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Building the submatrices");
 },
 55436: function($0, $1) {
  console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Done");
 },
 55548: function($0, $1) {
  console.log("__scran_wasm__ " + "tatami::load_layered_sparse_matrix" + " " + $0 + " " + $1 + " " + "Assigning lines to submatrices");
 },
...
var PThread = {
 ...
 initRuntime: function() {
  var tb = _malloc(228);
  for (var i = 0; i < 228 / 4; ++i) GROWABLE_HEAP_U32()[tb / 4 + i >>> 0] = 0;
  GROWABLE_HEAP_I32()[tb + 12 >>> 2] = tb;
  var headPtr = tb + 152;
  GROWABLE_HEAP_I32()[headPtr >>> 2] = headPtr;
  var tlsMemory = _malloc(512);
  for (var i = 0; i < 128; ++i) GROWABLE_HEAP_U32()[tlsMemory / 4 + i >>> 0] = 0;
 ...
 loadWasmModuleToWorker: function(worker, onFinishedLoading) {
  ...
  console.log(Module["mainScriptUrlOrBlob"]);
  worker.postMessage({
   "cmd": "load",
...
function ___pthread_create_js(pthread_ptr, attr, start_routine, arg) {
 ...
 for (var i = 0; i < 228 >> 2; ++i) GROWABLE_HEAP_U32()[(threadInfoStruct >> 2) + i >>> 0] = 0;
...
function ___sys_ftruncate64(fd, zero, low, high) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(3, 1, fd, zero, low, high);
 try {
